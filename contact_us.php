...
<head>
    ...
    <title>Contact Us | LuxeStone</title>
...
border-bottom: 1px solid rgba(198, 164, 63, 0.3);
        ...
        .info-card:hover, .form-card:hover {
            transform: translateY(-10px) scal
...
<div class="header">
    <div class="container">
        ...
        <div class="nav-links">
            ...
            <a href="order_details.php"><i class="fas fa-receipt"></i> Orders</a>
            <a href="contact.php" style="color:#C6A43F;"><i class="fas fa-envelope"></i> Contact</a>
            ...
            <div class="card-body">
                <div class="info-item">
                    ...
                    <div class="info-content">
                        <h3>Visit Us</h3>
                        <p>Luxury Jewelry District<br>Tehran, Iran</p>
                    </div>
                </div>
                <div class="info-item">
                    ...
                    <div class="info-content">
                        <h3>Call Us</h3>
                        <p>+98 21 1234 5678<br>+98 912 345 6789</p>
                    </div>
                </div>
                <div class="info-item">
                    ...
                    <div class="info-content">
                        <h3>Email Us</h3>
                        <p>info@luxestone.com<br>support@luxestone.com</p>
                    </div>
                </div>
